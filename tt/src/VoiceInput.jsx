...
const VoiceInput = forwardRef(
  ({ onCommand, lang = "hi-IN", useHinglish = true }, ref) => {
    ...
    return (
      <div className={styles.container}>
        <div className={styles.controls}>
          ...
          {micPermission === false && (
            <span className={styles.micBlocked}>
              ⚠️ Mic blocked — enable in browser
            </span>
          )}
        </div>
        ...
        <div className={styles.transcriptBox}>
          ...
          {finalText && (
            <p className={styles.final}>You said: "{finalText}"</p>
          )}
